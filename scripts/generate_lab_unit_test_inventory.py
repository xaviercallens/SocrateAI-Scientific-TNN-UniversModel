...
def generate_lab_test_inventory():
    inventory_md = f"""# INVENTAIRE ET RAPPORT DE TESTS UNITAIRES (LAB-0 À LAB-4)

**Projet :** SocrateAI Scientific TNN Univers Model  
**Statut de Certification :** TIER A (100% PASSED)  
**Date d'Exécution :** {time.strftime('%Y-%m-%d %H:%M:%S UTC', time.gmtime())}
...
"""
    ...
    report_path = os.path.join(cert_dir, "UNIT_TEST_INVENTORY_LAB0_TO_LAB4.md")
