...
// Module: HoloEngine.TopoStability
...
LEAN_EXPORT lean_object* lp_HoloEngine_HoloAlg_TDA_corrToDist(lean_object*);
LEAN_EXPORT lean_object* lp_HoloEngine_HoloAlg_TDA_corrToDist(lean_object* v_r_1_){
_start:
{
lean_object* v___x_2_; lean_object* v___f_3_; lean_object* v___f_4_; 
...
lean_closure_set(v___f_3_, 0, v_r_1_);
...
lean_closure_set(v___f_4_, 0, v___x_2_);
lean_closure_set(v___f_4_, 1, v___f_3_);
return v___f_4_;
}
}
...
LEAN_EXPORT lean_object* initialize_HoloEngine_HoloEngine_TopoStability(uint8_t builtin) {
lean_object * res;
